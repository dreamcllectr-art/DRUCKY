...
Split from config.py for maintainability. All symbols re-exported via config.py.
"""
...
>>>>>>> 57cc6e3 (Add 6 alt alpha modules: earnings NLP, gov intel, labor, supply chain, digital exhaust, pharma)
