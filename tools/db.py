...
def init_db():
    ...
    try:
        ...
        statements = [
            ...
            """CREATE TABLE IF NOT EXISTS module_health (run_date TEXT NOT NULL, module TEXT NOT NULL, phase TEXT NOT NULL, severity TEXT NOT NULL DEFAULT 'WARNING', error_msg TEXT, ts TEXT NOT NULL, PRIMARY KEY (run_date, module, phase, ts))""",
...
def _get_sa_engine():
    ...
    if _sa_engine is None:
        ...
        _sa_engine = create_engine(_DATABASE_URL, pool_size=5, max_overflow=5)
    return _sa_engine
