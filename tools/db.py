...
Provides SQLite connection management, query helpers, and bulk upsert.
...
def init_db():
    ...
    cur.executescript("""
        ...
        CREATE TABLE IF NOT EXISTS technical_scores (
            symbol TEXT,
            date TEXT,
            trend_score REAL, momentum_score REAL, volatility_score REAL,
            volume_score REAL, total_score REAL,
            PRIMARY KEY (symbol, date)
        );
        ...
        CREATE TABLE IF NOT EXISTS market_breadth (
            date TEXT PRIMARY KEY,
            advancers INTEGER, decliners INTEGER,
            new_highs INTEGER, new_lows INTEGER,
            adv_dec_ratio REAL, breadth_score REAL,
        ...
        CREATE TABLE IF NOT EXISTS news_sentiment (
            ...
            sentiment REAL,
            relevance REAL,
            PRIMARY KEY (symbol, date, headline)
        );
        ...
        CREATE TABLE IF NOT EXISTS filings_13f (
            ...
            value REAL,
            change_pct REAL,
            PRIMARY KEY (manager, symbol, date)
        );
        CREATE TABLE IF NOT EXISTS worldview_signals (
            date TEXT,
            thesis TEXT,
            direction TEXT,
            confidence REAL,
        ...
        CREATE TABLE IF NOT EXISTS foreign_intel_signals (
            symbol TEXT,
            date TEXT,
            source_country TEXT,
            signal_type TEXT,
            score REAL,
            details TEXT,
            PRIMARY KEY (symbol, date, source_country)
        );
        CREATE TABLE IF NOT EXISTS foreign_intel_url_cache (
            url TEXT PRIMARY KEY,
            fetched_date TEXT,
            content TEXT
        );
        CREATE TABLE IF NOT EXISTS foreign_ticker_map (
            foreign_symbol TEXT PRIMARY KEY,
            us_symbol TEXT,
            exchange TEXT,
            country TEXT
        );
        ...
        CREATE TABLE IF NOT EXISTS research_url_cache (
            url TEXT PRIMARY KEY,
            fetched_date TEXT,
            content TEXT
        );
        CREATE TABLE IF NOT EXISTS news_displacement (
            symbol TEXT,
            date TEXT,
        ...
        CREATE TABLE IF NOT EXISTS pattern_scan (
            symbol TEXT,
            date TEXT,
            pattern TEXT,
            score REAL,
        ...
        CREATE TABLE IF NOT EXISTS pattern_options_signals (
            symbol TEXT,
            date TEXT,
            score REAL,
            details TEXT,
        ...
        CREATE TABLE IF NOT EXISTS options_intel (
            symbol TEXT,
            date TEXT,
            put_call_ratio REAL,
            iv_rank REAL,
        ...
        CREATE TABLE IF NOT EXISTS letter_analysis (
            symbol TEXT,
            date TEXT,
            score REAL,
            summary TEXT,
        ...
        CREATE TABLE IF NOT EXISTS pair_spreads (
            ...
            spread REAL,
            z_score REAL,
            PRIMARY KEY (symbol_a, symbol_b, date)
        );
        CREATE TABLE IF NOT EXISTS pair_signals (
            ...
            direction TEXT,
            details TEXT,
            PRIMARY KEY (symbol_a, symbol_b, date, signal_type)
        );
        ...
        CREATE TABLE IF NOT EXISTS ma_rumors (
            symbol TEXT,
            date TEXT,
            source TEXT,
            headline TEXT,
        ...
        CREATE TABLE IF NOT EXISTS hl_price_snapshots (
            ticker TEXT,
            timestamp TEXT,
            mid_price REAL,
            deployer TEXT,
            PRIMARY KEY (ticker, timestamp, deployer)
        );
        CREATE TABLE IF NOT EXISTS hl_gap_signals (
            ticker TEXT,
            date TEXT,
            predicted_gap REAL,
            actual_gap REAL,
        ...
        CREATE TABLE IF NOT EXISTS hl_deployer_spreads (
            ticker TEXT,
            date TEXT,
            deployer_a TEXT,
            deployer_b TEXT,
            spread REAL,
            PRIMARY KEY (ticker, date, deployer_a, deployer_b)
        );
        ...
        CREATE TABLE IF NOT EXISTS world_macro_indicators (
            indicator TEXT,
            country TEXT,
            date TEXT,
            value REAL,
        ...
        CREATE TABLE IF NOT EXISTS estimate_momentum_signals (
            ...
            date TEXT,
            em_score REAL,
            revision_velocity REAL,
            surprise_momentum REAL,
            details TEXT,
            PRIMARY KEY (symbol, date)
        );
        ...
        CREATE TABLE IF NOT EXISTS thematic_ideas (
            id INTEGER PRIMARY KEY AUTOINCREMENT,
            date TEXT,
            theme TEXT,
            symbols TEXT,
        ...
        CREATE TABLE IF NOT EXISTS ai_exec_investments (
            ...
            amount REAL,
            details TEXT,
            PRIMARY KEY (symbol, date, investment_type)
        );
        ...
        CREATE TABLE IF NOT EXISTS energy_intel_signals (
            symbol TEXT,
            date TEXT,
            score REAL,
            signal_type TEXT,
        ...
        CREATE TABLE IF NOT EXISTS energy_eia_enhanced (
            series_id TEXT,
            date TEXT,
            value REAL,
            category TEXT,
        ...
        CREATE TABLE IF NOT EXISTS energy_supply_anomalies (
            date TEXT,
            anomaly_type TEXT,
            severity REAL,
            details TEXT,
            PRIMARY KEY (date, anomaly_type)
        );
        CREATE TABLE IF NOT EXISTS energy_trade_flows (
            ...
            flow_type TEXT,
            value REAL,
            PRIMARY KEY (date, country, product, flow_type)
        );
        CREATE TABLE IF NOT EXISTS energy_seasonal_norms (
            week_of_year INTEGER,
            product TEXT,
            avg_value REAL,
            std_value REAL,
            PRIMARY KEY (week_of_year, product)
        );
        CREATE TABLE IF NOT EXISTS energy_jodi_data (
            country TEXT,
            product TEXT,
            date TEXT,
            value REAL,
            flow TEXT,
            PRIMARY KEY (country, product, date, flow)
        );

        -- Global Energy Markets tables
        CREATE TABLE IF NOT EXISTS global_energy_benchmarks (
            benchmark_id TEXT,
            date TEXT,
            name TEXT,
            unit TEXT,
        ...
        CREATE TABLE IF NOT EXISTS global_energy_curves (
            curve_id TEXT,
            date TEXT,
            months_out INTEGER,
            ...
            price REAL,
            last_updated TEXT,
            PRIMARY KEY (curve_id, date, months_out)
        );
        CREATE TABLE IF NOT EXISTS global_energy_spreads (
            spread_id TEXT,
            date TEXT,
            name TEXT,
            value REAL,
            ...
            unit TEXT,
            last_updated TEXT,
            PRIMARY KEY (spread_id, date)
        );
        CREATE TABLE IF NOT EXISTS global_energy_carbon (
            market_id TEXT,
            date TEXT,
            source_ticker TEXT,
            price REAL,
        ...
        CREATE TABLE IF NOT EXISTS global_energy_signals (
            symbol TEXT,
            date TEXT,
            gem_score REAL,
            category TEXT,
            term_structure_signal REAL,
            basis_signal REAL,
            crack_signal REAL,
            carbon_signal REAL,
            narrative TEXT,
        ...
        -- Signal Conflicts (cross-module contradiction detection)
